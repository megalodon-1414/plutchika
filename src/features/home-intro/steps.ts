  ...
  },
  {
    ...
    content: {
      ...
      body: [
        ...
        {
          text: 'では、自分の感情にぴったりな「名前」をつけてあげるだけで、\n脳のストレスが和らぎ、心がすっと整うことが分かっています。\n「Plutchika(ぷるちか)」は、あなたの「心の現在地」を定義するためのwebサイトです。',
        },
      ],
    },
  },
  {
    ...
    content: {
      ...
      body: [
        ...
        {
          text: '」は、8つの基本感情に\n色と位置を与え、感情をひとつの地図として表したものです。\nPLUTCHIKAは、このプルチック環をもとに、感情を表す言葉をひとつひとつ段階に分けて位置づけ、マッピングしました。\n大きな感情から、少しずつニュアンスの違う言葉へ——\n地図の上を「',
        },
        { text: '探索', linkTo: `${ROUTES.deepDive}?panel=4&from=emotion-wheel` },
        {
          text: '」するように辿っていくと、\n今のあなたにぴったりな一語が見つかるはずです。\nさあ、その言葉を探しに行きましょう。',
        },
      ],
